 ...
 * @numbers: The characters to pick password from
 * @uppers: The characters to pick password from
 * @lowers: The characters to pick password from
 * @symbols: The characters to pick password from
